...
stub_router_client.copilot_llm_call = lambda **_: {"response": "test", "artifact": {}}
sys.modules["model_router_client"] = stub_router_client

import hand_gesture_detection

DEFAULT_STAGE2_RESPONSE = "Person is waving hello. A thumbs up usually means approval."
...
class TestHandGestureDetection(unittest.TestCase):
    ...
    def _install_stub(self, stage1_result, stage2_response=DEFAULT_STAGE2_RESPONSE):
        def _stub(**kwargs):
