...
TOOL_PROMPT = (
    ...
    "Use simple language and clock-face positions (e.g. 12 o'clock straight ahead, 3 o'clock to the right) "
    "to indicate direction. Keep the total response under 60 words and audio-friendly."
)
